...
<link rel="stylesheet" href="./style_leave_form.css">
<style>
...
<div id="wrapper">
 ...
 -->              </li>
    ...
    <form class="well form-horizontal" action="leave" method="post"  id="contact_form">
<fieldset>

<!-- Form Name -->
<legend><center><h2><b>Leave Form</b></h2></center></legend><br>
...
<div class="form-group">
  ...
  <input  name="start_date" placeholder="Username" class="form-control"  type="date">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >End_Date</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
  <input name="end_date" placeholder="Password" class="form-control"  type="date">
    </div>
  </div>
</div>
...
<script  src="./js_leave_form.js"></script>
